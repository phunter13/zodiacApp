...
},
{
	...
	months: "October 23 to November 22",
...
},
{
	...
	months: "December 22 to January 19",
...
},
{
	...
	months: "February 19 to March 20",
...
function getData(){
	...
	for (var i = 0; i < zodiacs.length; i++) {
		if(userSearch === zodiacs[i].name.toLowerCase()) {
			...
			document.getElementById('date').innerHTML = zodiacs[i].months;
